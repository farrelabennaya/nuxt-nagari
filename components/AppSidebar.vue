      ...
      <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
          <ul class="space-y-2 pb-2">
            ...
            <!-- <li>
              <NuxtLink
                to="/menu/datainventory"
                class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span class="ml-3 flex-1 whitespace-nowrap">Data User</span>
              </NuxtLink>
            </li>
            <!-- <li>
