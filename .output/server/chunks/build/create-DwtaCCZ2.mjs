...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto sm:ml-64"><main><div class="pt-6 px-4 ml-5 mr-5"><h1 class="text-lg font-bold mb-4">Create Keluarga</h1></div></main><div class="min-h-screen flex"><div class="w-full"><div class="card bg-white p-10 rounded-lg shadow-md md:w-3/5 mx-auto lg:w-1/3"><h3 class="text-center text-2xl font-semibold">Keluarga Data</h3><form class="max-w-sm mx-auto"><div class="mb-5">`);
      _push(ssrRenderComponent(_component_FormLabel, { for: "jumlah_kk" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Jumlah KK`);
          } else {
            return [
              createTextVNode("Jumlah KK")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/nagari/keluarga/create.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=create-DwtaCCZ2.mjs.map
