...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<aside${ssrRenderAttrs(mergeProps({
    ...
    "aria-label": "Sidebar"
  }, _attrs))}><div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800"><ul class="space-y-2 font-medium"><li>`);
  ...
  _push(`</li></ul></div><div class="space-y-2 pt-2"></div></aside>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarPetugas.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      const _component_SidebarPetugas = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(AppHeader, null, null, _parent));
      _push(`<div class="flex overflow-hidden bg-white pt-16">`);
      _push(ssrRenderComponent(_component_SidebarPetugas, null, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/petugas/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-gQwCSfQN.mjs.map
