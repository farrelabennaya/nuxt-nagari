        ...
        <div class="card p-10 md:w-3/4 mx-auto lg:w-1/3">
          <div class="hero min-h-screen bg-base-200">
            <div class="hero-content text-center">
              <div class="max-wd">
                  <h1 class="text-3xt font-bold">This Dashboard Page</h1>
      ...
      <div class="w-full">
        <div class="card p-10 md:w-3/4 mx-auto lg:w-1/3">
          <div class="hero min-h-screen bg-base-200">
            <div class="hero-content text-center">
              <div class="max-wd">
                  <h1 class="text-3xt font-bold py-3">Halaman Dashboard Petugas</h1>
                  <!-- <p class="py-6">Welcome to Dashboard Page</p> -->
                  <p class="py-2">Semoga harimu cerah, <strong>{{ auth.getUser?.name }}</strong></p>
                  <p class="py-1">Username kamu adalah <strong>{{ auth.getUser?.username }}</strong></p>
                  <!-- <button class="btn btn-primary">Get Started</button> -->
              </div>
            </div>
          </div>
